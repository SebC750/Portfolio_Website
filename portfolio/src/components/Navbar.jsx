            ...
            <div className="container-fluid">
                ...
                <div className="collapse navbar-collapse" id="menu">
                    ...
                    <div className="d-flex align-items-center text-center text-sm-left justify-content-center gap-2">
                        <a className="pb-2 ps-0 ps-md-2 p-1" href="https://github.com/SebC750" aria-label="Go to my github profile to see my works">
                            <img src="LI-In-Bug.png" aria-label="LinkedIn navbar profile icon link" alt="linkedin logo" height="35" width="40" />
                        </a>
                        <a className="pb-2 ps-0 p-1" href="https://www.linkedin.com/in/sebastian-chalarca-603939201/" aria-label="Go to my linkedin profile to learn more about me.">
