            ...
            <>
              <div key={index} className="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-3 d-flex align-items-stretch pb-4">
                <div className="card border-0 shadow shadow-xl w-100 bg-dark text-yellow">
                  <img src={val.project_thumbnail} alt={`Project thumbnail for ${val.project_name}`} className="card-img-top object-fit-cover" height="300px" />
                  <div className="card-body d-flex flex-column justify-content-between">
                    ...
                    <button className="btn btn-yellow rounded-0 d-block w-100 btn-lg">
                      {!val.project_link.includes("github") ? (
                        <>
                          <a className="nav-link" href={val.project_link}> <i className="bi bi-globe fs-3"></i> Link to project </a>
                        </>
                      ) :
                        (
                          <>
                            <a className="nav-link" href={val.project_link}> <i className="bi bi-github fs-3"> </i>Vist github page </a>
                          </>
                        )}
